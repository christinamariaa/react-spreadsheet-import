...
var Autocomplete = require('../../../components/Fields/Autocomlete/Autocomplete.js');
...
const generateColumns = (fields) => [
    ...
    ...fields.map((column) => ({
        ...
        minWidth: 150,
        resizable: true,
        headerRenderer: () => (jsxRuntime.jsxs(react.Box, { display: "flex", gap: 1, alignItems: "center", position: "relative", children: [jsxRuntime.jsx(react.Box, { flex: 1, overflow: "hidden", textOverflow: "ellipsis", children: column.label }), column.description && (jsxRuntime.jsx(react.Tooltip, { placement: "top", hasArrow: true, label: column.description, children: jsxRuntime.jsx(react.Box, { flex: "0 0 auto", children: jsxRuntime.jsx(cg.CgInfo, { size: "16px" }) }) }))] })),
        ...
        editor: ({ row, onRowChange, onClose }) => {
            ...
            switch (column.fieldType.type) {
                case "select":
                    ...
                    break;
                case "autocomplete":
                    component = (jsxRuntime.jsx(react.Box, { paddingInlineStart: "0.5rem", children: jsxRuntime.jsx(Autocomplete.Autocomplete, { searcher: column.fieldType.searcher, placeholder: column.fieldType.placeholder, formatOption: column.fieldType.formatOption, value: row[column.key], onSelect: (id) => {
        ...
        formatter: ({ row, onRowChange }) => {
            ...
            switch (column.fieldType.type) {
                ...
                case "autocomplete":
                    ...
                    component = (jsxRuntime.jsx(react.Box, { minWidth: "100%", minHeight: "100%", overflow: "hidden", textOverflow: "ellipsis", children: selected || "" }));
                    break;
                default:
